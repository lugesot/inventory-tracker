...
<div>
    <div class="easyui-panel" title="查询" data-options="iconCls:'icon-search',collapsible:true"
        ...
        <form id="system_query_form">
            <div class="row">
				<span>
					<lable>系统名：</lable>
	                <input type="text" id="sysname" class="easyui-textbox input" style="height:25px;"/>
				</span>
                <span><a id="system_query_button" href="javascript:void(0)" class="easyui-linkbutton btn"
                         iconCls="icon-search">查询</a></span>
            </div>
        </form>
    </div>
    <div style="margin-top:10px;">
        <table id="system_grid" style="width: 100%">
        </table>
    </div>
</div>
<div id="system_dialog" class="dialog"></div>
...
<script src="/static/script/systemList.js"></script>
